...
<!-- https://gist.github.com/psylinse/a761302f2a7167c70becefbbc1652ffe -->
```jsx
...
<!-- https://gist.github.com/psylinse/61a55a25ac84212d100a7e92d6e97a04 -->
```jsx
const startChat = async () => {
...
<!-- https://gist.github.com/psylinse/d6c93e15b7527e4e9ed3c5e4babbe8ab -->
```javascript
...
<!-- https://gist.github.com/psylinse/e4cb88fbb40a72ab5376f96161a4034f -->
```jsx
...
<!-- https://gist.github.com/psylinse/6f1d03728d639e7e132e7046d4f916ff -->
```javascript
...
<!-- https://gist.github.com/psylinse/76e76c28fb0fda8c6cf0bc42e3aac827 -->
```javascript
