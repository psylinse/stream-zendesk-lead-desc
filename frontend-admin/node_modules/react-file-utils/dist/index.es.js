  ...
  _createClass(FileIcon, [{
    ...
    value: function render() {
      ...
      if (big) {
        ...
        return createElement(BigFileIcon, _extends({
...
function (_React$PureComponent) {
  ...
  _createClass(FileUploadButton, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        className: "rfu-file-upload-button"
        ...
        onChange: function onChange(event) {
          ...
          if (_this2.inputRef !== null && _this2.inputRef !== undefined) _this2.inputRef.value = '';
        },
...
_defineProperty(FileUploadButton, "defaultProps", {
  multiple: false,
  children: createElement(AttachmentIcon, null),
  disabled: false
});
...
function (_React$PureComponent) {
  ...
  function ImageDropzone() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_handleFiles", function _callee(accepted, rejected) {
      var handleFiles, fileLikes;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return _context.abrupt("return", handleFiles(accepted));

            case 5:
              _context.next = 7;
              return _regeneratorRuntime.awrap(dataTransferItemsToFiles(rejected));

            case 7:
              fileLikes = _context.sent;
              ...
              return _context.abrupt("return", handleFiles(fileLikes));
  ...
  _createClass(ImageDropzone, [{
    ...
    value: function render() {
      ...
      return createElement(Dropzone, {
        ...
        fill: "#000",
        fillRule: "nonzero"
      })), createElement("p", null, "Drag your files here to add to your post"))), children);
    }
  }]);
...
_defineProperty(ImageUploadButton, "defaultProps", {
  multiple: false,
  disabled: false,
  children: createElement(PictureIcon, null)
});
